...
export const about_us_why_us = {
  title: "Why Choose Us",
  content: `We strive to make the complex world of legal matters as smooth and approachable as possible, with a promise to uphold the highest standards of integrity and professionalism in all that we do.`,
};
